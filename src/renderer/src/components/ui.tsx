...
const PATHS: Record<string, string> = {
  ...
  issue: 'M8 0a8 8 0 1 1 0 16A8 8 0 0 1 8 0ZM1.5 8a6.5 6.5 0 1 0 13 0 6.5 6.5 0 0 0-13 0ZM8 5a1.5 1.5 0 1 1 0 3 1.5 1.5 0 0 1 0-3Z',
  worktree: 'M5 5.372v.878c0 .414.336.75.75.75h4.5a.75.75 0 0 0 .75-.75v-.878a2.25 2.25 0 1 1 1.5 0v.878a2.25 2.25 0 0 1-2.25 2.25h-1.5v2.128a2.251 2.251 0 1 1-1.5 0V8.5h-1.5A2.25 2.25 0 0 1 3.5 6.25v-.878a2.25 2.25 0 1 1 1.5 0ZM5 3.25a.75.75 0 1 0-1.5 0 .75.75 0 0 0 1.5 0Zm6.75.75a.75.75 0 1 0 0-1.5.75.75 0 0 0 0 1.5Zm-3 8.75a.75.75 0 1 0-1.5 0 .75.75 0 0 0 1.5 0Z',
  bell: 'M8 16a2 2 0 0 0 1.985-1.75c.017-.137-.097-.25-.235-.25h-3.5c-.138 0-.252.113-.235.25A2 2 0 0 0 8 16ZM8 1.5A6.5 6.5 0 0 0 1.5 8c0 .994-.13 1.868-.332 2.62-.204.755-.478 1.29-.69 1.63a.75.75 0 0 0 .628 1.148c1.892.088 3.925.138 6.116.138 2.191 0 4.224-.05 6.115-.137a.75.75 0 0 0 .628-1.15c-.212-.338-.486-.874-.69-1.629C14.63 9.868 14.5 8.994 14.5 8A6.5 6.5 0 0 0 8 1.5Z',
};
...
export interface MenuItem {
  ...
  shortcut?: string;
  icon?: IconName;
  /** Native tooltip, shown even (especially) when the item is disabled, e.g. to explain why. */
  title?: string;
}
